...
const Header: React.FC = () => {
  return (
    <header className={`w-full py-[70px] md:bg-[url("./assets/cover.png")] from-[#fbc300] to-[#c98a00] bg-[url('./assets/cover-mobile.png')] flex flex-col items-center md:justify-between justify-center text-white bg-cover`}>
      <div className="w-24 pt-[40px] mx-auto">
        <p>
      ...
      <div className="text-[38px] font-light my-[38px]">
